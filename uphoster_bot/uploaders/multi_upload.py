...
from .devuploads import DevUploadsUpload
from .vikingfile import VikingFileUpload
from .buzzheavier import BuzzHeavierUpload
from .gofile import GoFileUpload
from .pixeldrain import PixelDrainUpload
...
class MultiUphosterUpload:
    def __init__(self, listener, path, services, folder_name=""):
        ...
        for service in services:
            uploader_cls = SERVICE_MAP.get(service.strip().lower())
            if uploader_cls:
